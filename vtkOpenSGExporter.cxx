...
void vtkOpenSGExporter::SetFilePointer(FILE *fp)
{
...
void vtkOpenSGExporter::WriteALight(vtkLight *aLight, FILE *fp)
{
...
void vtkOpenSGExporter::WriteAnActor(vtkActor *anActor, FILE *fp)
{
...
void vtkOpenSGExporter::WriteShapeBegin( vtkActor* actor, FILE *fileP,
...
void vtkOpenSGExporter::WriteShapeEnd( FILE *fileP )
{
  fprintf(fileP,"        }\n"); // close the  Shape
}

void vtkOpenSGExporter::WritePointData(vtkPoints *points, vtkDataArray *normals,
